...
{   var d = new Date("1111/1/1,0:" + x + ":0");
    ...
    {   var m = d.getMinutes();
        ...
        m = m < 10 ? "0" + m : m;
        s = s < 10 ? "0" + s : s;
        end.innerHTML="剩余时间："+m + ":" + s+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目前得分："+removeNum+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;通关要求：150&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提示次数：0";
        end.style.color ="red";
        end.style.fontSize = '14';
        if (m == 0 && s == 0)
        {   alert("游戏结束！您的得分是"+removeNum+"点击确认后将为您跳转到南京理工大学教务处综合教务管理系统网站。");
            clearInterval(interval);
            top.location="http://202.119.81.112:8080/";
        }
        d.setSeconds(s - 1);
    }, 1000);
}
